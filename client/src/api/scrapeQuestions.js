...
function transformTags() {
  data['questions'].map((question) => {
    question.topicTags = question.topicTags.map((topic) => topic.name).splice(0,2)
    return question
  }) 
  console.log(data)
}
